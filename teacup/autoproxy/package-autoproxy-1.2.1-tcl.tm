...
# @@ Meta Begin
# Package autoproxy 1.2.1
# Meta as::origin  http://sf.net/projects/tcllib
# Meta category    HTTP protocol helper modules
# Meta description Automatic HTTP proxy usage and authentication
# Meta license     BSD
# Meta platform    tcl
# Meta require     base64
# Meta require     BWidget
# Meta require     http
# Meta require     {registry 1.0 -platform windows}
# Meta require     {Tcl 8.2}
# Meta require     uri
# Meta subject     authentication http proxy
# @@ Meta End


##########

########## Requirements Enforcement Code ###
...
########## Package Declaration Code ###

package provide autoproxy 1.2.1
