...
# Meta as::build::date 2015-04-24
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        SHA-x Message-Digest Algorithm
# Meta description     SHA256 Message-Digest Algorithm
# Meta license         BSD
# Meta platform        tcl
# Meta recommend       tcllibc
# Meta require         {Tcl 8.2}
# Meta subject         security sha256 {FIPS 180-1} {rfc 2104}
# Meta subject         message-digest hashing
# Meta summary         sha256
# @@ Meta End
