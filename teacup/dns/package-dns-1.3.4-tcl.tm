...
# Meta description     Tcl Domain Name Service Client
# Meta license         BSD
# Meta platform        tcl
# Meta recommend       ceptcl
# Meta recommend       {udp 1.0.4}
# Meta require         {Tcl 8.2}
# Meta require         ip
# Meta require         logger
# Meta require         {registry -platform windows}
# Meta require         uri
# Meta require         uri::urn
# Meta subject         {rfc 1035} DNS {rfc 1886} resolver
# Meta subject         {domain name service} {rfc 1034}
# Meta summary         dns
# @@ Meta End
